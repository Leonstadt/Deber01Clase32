#sistema de banco usando listas
usuarios=[]
cuentas=[]

def agregar_usuario():
    #permite registrar un usuario a la lista "usuarios", si existe, se solicita ingresar otro usuario
    while True:
...
def depositar():
    #permite agregar dinero al usuario dentro de la lista "usuarios"
...
def retirar():
    #permite retirar dinero al usuario dentro de la lista "usuarios"
...
def consultar_saldo():
    #tarea - nos permite consultar el saldo de la cuenta
